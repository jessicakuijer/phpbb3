...
class __TwigTemplate_a6e96e9b60436ad708d5120589c74a0f extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["S_AJAX_CHAT_VIEW"] ?? null)) {
            // line 2
            echo "\t";
            if ((($context["S_AJAX_CHAT_VIEWFORUM_OVERRIDE"] ?? null) || (($context["S_AJAX_CHAT_VIEWFORUM"] ?? null) && twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["loops"] ?? null), "topicrow", [], "any", false, false, false, 2))))) {
                // line 3
                echo "\t\t";
...
\t\t";
    ...
    {
        return new Source("", "@spaceace_ajaxchat/event/viewforum_forum_title_after.html", "");
    }
}
