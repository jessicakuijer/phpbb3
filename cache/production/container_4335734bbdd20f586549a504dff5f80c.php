...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->privates = [
            ...
            'spaceace.ajaxchat.chat.controller' => true,
            'spaceace.ajaxchat.cron.task.prune_ajaxchat' => true,
            'spaceace.ajaxchat.listener' => true,
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addListener('core.viewonline_overwrite_location', [0 => function () {
            return ${($_ = isset($this->services['spaceace.ajaxchat.listener']) ? $this->services['spaceace.ajaxchat.listener'] : $this->getSpaceace_Ajaxchat_ListenerService()) && false ?: '_'};
        }, 1 => 'add_page_viewonline'], 0);
        ...
        $instance->addListener('core.viewforum_get_topic_data', [0 => function () {
            return ${($_ = isset($this->services['spaceace.ajaxchat.listener']) ? $this->services['spaceace.ajaxchat.listener'] : $this->getSpaceace_Ajaxchat_ListenerService()) && false ?: '_'};
        }, 1 => 'index'], 0);
        ...
        $instance->addListener('core.acp_users_prefs_modify_data', [0 => function () {
            return ${($_ = isset($this->services['spaceace.ajaxchat.listener']) ? $this->services['spaceace.ajaxchat.listener'] : $this->getSpaceace_Ajaxchat_ListenerService()) && false ?: '_'};
        }, 1 => 'acp_users_chat_settings_get'], 0);
        $instance->addListener('core.acp_users_prefs_modify_template_data', [0 => function () {
            return ${($_ = isset($this->services['spaceace.ajaxchat.listener']) ? $this->services['spaceace.ajaxchat.listener'] : $this->getSpaceace_Ajaxchat_ListenerService()) && false ?: '_'};
        }, 1 => 'acp_profile_ajax_chat_template'], 0);
        $instance->addListener('core.acp_users_prefs_modify_sql', [0 => function () {
            return ${($_ = isset($this->services['spaceace.ajaxchat.listener']) ? $this->services['spaceace.ajaxchat.listener'] : $this->getSpaceace_Ajaxchat_ListenerService()) && false ?: '_'};
        }, 1 => 'ucp_profile_ajax_chat_set'], 0);
    ...
    /**
     * Gets the private 'spaceace.ajaxchat.chat.controller' shared service.
     *
     * @return \spaceace\ajaxchat\controller\chat
     */
    protected function getSpaceace_Ajaxchat_Chat_ControllerService()
    {
        return $this->services['spaceace.ajaxchat.chat.controller'] = new \spaceace\ajaxchat\controller\chat(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['template_context']) ? $this->services['template_context'] : ($this->services['template_context'] = new \phpbb\template\context())) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, ${($_ = isset($this->services['path_helper']) ? $this->services['path_helper'] : $this->getPathHelperService()) && false ?: '_'}, 'phpbb_', './', 'php', 'phpbb_posts', 'phpbb_users', 'phpbb_ajax_chat', 'phpbb_ajax_chat_sessions');
    }

    /**
     * Gets the private 'spaceace.ajaxchat.cron.task.prune_ajaxchat' shared service.
     *
     * @return \spaceace\ajaxchat\cron\task\prune_ajaxchat
     */
    protected function getSpaceace_Ajaxchat_Cron_Task_PruneAjaxchatService()
    {
        $this->services['spaceace.ajaxchat.cron.task.prune_ajaxchat'] = $instance = new \spaceace\ajaxchat\cron\task\prune_ajaxchat(${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['log']) ? $this->services['log'] : $this->getLogService()) && false ?: '_'}, 'phpbb_ajax_chat');
    ...
    /**
     * Gets the private 'spaceace.ajaxchat.listener' shared service.
     *
     * @return \spaceace\ajaxchat\event\listener
     */
    protected function getSpaceace_Ajaxchat_ListenerService()
    {
        return $this->services['spaceace.ajaxchat.listener'] = new \spaceace\ajaxchat\event\listener(${($_ = isset($this->services['template']) ? $this->services['template'] : $this->getTemplateService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['request']) ? $this->services['request'] : ($this->services['request'] = new \phpbb\request\request(NULL, true))) && false ?: '_'}, ${($_ = isset($this->services['controller.helper']) ? $this->services['controller.helper'] : $this->getController_HelperService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['config_text']) ? $this->services['config_text'] : $this->getConfigTextService()) && false ?: '_'}, ${($_ = isset($this->services['ext.manager']) ? $this->services['ext.manager'] : $this->getExt_ManagerService()) && false ?: '_'}, 'php', 'phpbb_ajax_chat', ${($_ = isset($this->services['spaceace.ajaxchat.chat.controller']) ? $this->services['spaceace.ajaxchat.chat.controller'] : $this->getSpaceace_Ajaxchat_Chat_ControllerService()) && false ?: '_'});
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.ajax_chat' => 'phpbb_ajax_chat',
            'tables.ajax_chat_sessions' => 'phpbb_ajax_chat_sessions',
            'tables' => [
                ...
                'words' => 'phpbb_words',
                'zebra' => 'phpbb_zebra',
                'ajax_chat' => 'phpbb_ajax_chat',
                'ajax_chat_sessions' => 'phpbb_ajax_chat_sessions',
            ],
